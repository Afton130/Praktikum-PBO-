                ...
                case 3:
                    ...
                    for (Book b : koleksi) {
                        if (b.judul.equalsIgnoreCase(pinjam)) {
                            ada = true;
                            if (b.isBooked) {
                                System.out.println("❌ Gagal: Buku '" + b.judul + "' sudah sedang dipinjam.");
                            } else {
                                b.isBooked = true; // Set status menjadi dipinjam
                                System.out.println("✅ Berhasil: Buku '" + b.judul + "' berhasil dipinjam.");
                            }
                            break;
                        }
                    }
                    if (!ada) {
                        System.out.println("❌ Gagal: Buku dengan judul '" + pinjam + "' tidak ditemukan.");
                    }
                    break;
                ...
                case 4:
                    ...
                    for (Book b : koleksi) {
                        if (b.judul.equalsIgnoreCase(kembali)) {
                            ...
                            if (b.isBooked) {
                                b.isBooked = false; // Set status menjadi belum dipinjam
                                System.out.println("✅ Berhasil: Buku '" + b.judul + "' berhasil dikembalikan.");
                            } else {
                                System.out.println("❌ Gagal: Buku '" + b.judul + "' tidak dalam status dipinjam.");
                            }
                            break;
                        }
                    }
                    if (!ditemukanKembali) {
                        System.out.println("❌ Gagal: Buku dengan judul '" + kembali + "' tidak ditemukan.");
                    }
                    break;
